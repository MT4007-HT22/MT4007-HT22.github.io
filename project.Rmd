...
e. Create a 5 minute presentation about your work to present to your fellow students on 2023-01-12. The main aim of your presentation is to convince your fellow students that they should read your blog post. A template for this will be made available within the next days. 
...
a. Technical difficulty of the project, i.e. how hard to get the data imported, how much time needed to wrangle, how advanced are some of the methods to get statistical summaries, use of additional technical shenanigans[^2], how original is the project idea
...
[^2]: Examples: using a [`targets` pipeline](https://books.ropensci.org/targets/) (Sect. 10.1), visualize using an interactive [Shiny app](https://shiny.rstudio.com/) , [parallel computing](https://future.futureverse.org/), ...