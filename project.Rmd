...
Additional public web based data sources could, e.g., be the [Stockholm Open Data Portal ](https://dataportalen.stockholm.se/dataportalen/).
...
For every student we will create a private `PR_<username>` GitHub repository as part of the [MT4007-HT22 organisation](https://github.com/MT4007-HT22), which only you and the teachers of the course have read/write access to (similar setup as your `HW_<username>` repo) You should make sub-directories `Data`, `R`, `Report` and `Presentation` and store all your files there. At the project deadline we will pull all repos, which have an issue "Project work submitted".
